package com.enigma.tugcustomlist;
            ...
            public void  onItemClick(AdapterView<?> parent, View view, int position, long id){
                switch (position) {
                    case 0:
                        ...
                        intent.putExtra("gambar", R.drawable.nintendo_color_tv_game);
                    ...
                    case 1:
                        ...
                        intent.putExtra("gambar", R.drawable.nintendo_entertainment_system_model);
                        startActivity(intent);
                        break;
                    case 2:
                        ...
                        intent.putExtra("gambar", R.drawable.super_nintendo_north_america_model);
                        startActivity(intent);
                        break;
                    case 3:
                    ...
                    case 4:
                        ...
                        intent.putExtra("gambar", R.drawable.nintendo_gamecube_purple_model);
                        startActivity(intent);
                        break;
                    case 5:
                        ...
                        intent.putExtra("gambar", R.drawable.panasonicq);
                        startActivity(intent);
                        break;
                    case 6:
                        ...
                        intent.putExtra("gambar", R.drawable.the_nintendo_wii);
                        startActivity(intent);
                        break;
                    case 7:
                        ...
                        intent.putExtra("gambar", R.drawable.wiiminiconsole);
                        startActivity(intent);
                        break;
                    case 8:
                        ...
                        intent.putExtra("gambar", R.drawable.wii_u_console_and_gamepad);
                        startActivity(intent);
                        break;
                    case 9:
                        ...
                        intent.putExtra("gambar", R.drawable.nintendo_switch);
                        startActivity(intent);
                        break;
                    default:
                        break;
